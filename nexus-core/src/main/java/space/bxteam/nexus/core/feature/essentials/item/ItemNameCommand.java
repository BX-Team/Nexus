...
public class ItemNameCommand {
    ...
    void execute(@Context Player player, @Join Component name) {
        ...
        if (itemStack == null) {
            this.messageManager.player(player, translation -> translation.argument().noItem());
            return;
        }
    ...
    void clear(@Context Player player) {
        ...
        this.messageManager.player(player, translation -> translation.item().itemClearNameMessage());
    }
