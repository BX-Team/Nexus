...
public class RUTranslation extends OkaeriConfig implements Translation {
    ...
    public class RUJailSection extends OkaeriConfig implements JailSection {
        ...
        public Notice jailAlreadyJailed = Notice.chat("<dark_red>✘ Игрок <white>{PLAYER} <dark_red>уже находится в тюрьме!");
    ...
    public class RURandomTeleportSection extends OkaeriConfig implements RandomTeleportSection {
        public Notice randomTeleportSearchStart = Notice.chat("<green>► Поиск случайных координат начат...");
        ...
        @Comment("")
        public Notice randomTeleportTeleported = Notice.chat("<green>✔ Вы были телепортированы на случайные координаты!");
        @Comment("{PLAYER} - Игрок который будет телепортирован")
    ...
    public class RUTeleportRequestSection extends OkaeriConfig implements TeleportRequestSection {
        ...
        public Notice tpaReceivedMessage = Notice.builder()
                ...
                .chat("<hover:show_text:'<green>Принять запрос на телепортацию</green>'><gold><click:suggest_command:'/tpaccept {PLAYER}'><暗_gray>▷ <gold>/tpaccept {PLAYER} <green>чтобы принять! <gray>(Нажмите)</gray></click></gold></hover>")
                .chat("<hover:show_text:'<red>Отклонить запрос на телепортацию</red>'><gold><click:suggest_command:'/tpdeny {PLAYER}'><暗_gray>▷ <gold>/tpdeny {PLAYER} <red><green>чтобы отклонить! <gray>(Нажмите)</gray></click></gold></hover>")
                .build();
    ...
    public class RUSignEditorSection extends OkaeriConfig implements SignEditorSection {
        ...
        public Notice lineSet = Notice.chat("<green>✔ Линия <white>{LINE} <green>была установлена на <white>{TEXT}");
    }
