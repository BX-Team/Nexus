package org.bxteam.nexus.core.database.clients;
...
public class SQLiteClient implements DatabaseClient {
    ...
    @Inject
    public SQLiteClient(@Named("dataFolder") Path dataDirectory, PluginConfigurationProvider configurationProvider) {
    ...
    public void open() throws SQLException {
        ...
        this.dataSource.setJdbcUrl("jdbc:sqlite:" + this.dataDirectory.toAbsolutePath() + "/" + this.configurationProvider.configuration().database().sqlite().file());
