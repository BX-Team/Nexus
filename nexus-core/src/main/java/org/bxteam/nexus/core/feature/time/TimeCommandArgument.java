package org.bxteam.nexus.core.feature.time;
...
public class TimeCommandArgument extends MultificationLiteArgument<Integer> {
    ...
    @Inject
    public TimeCommandArgument(TranslationProvider translationProvider, PluginConfigurationProvider configurationProvider) {
